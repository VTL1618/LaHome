//
//  RadiateurControlViewController.swift
//  LaHome
//
...
class RadiateurControlViewController: UIViewController {
    
    var viewModel: RadiateurControlViewModelProtocol!
...
extension RadiateurControlViewController {
